...
val libraryArtifactId by extra("adtalos-adapter")
...
repositories {
    maven { url = uri("https://nexus.mobrtb.com/repository/sdk") }
}

dependencies {
    implementation("com.xy.sdk:adtalos-sdk:${libraryVersions["adtalos"]}")
}
        ...
        create<MavenPublication>(extra["publicationName"] as String) {
            ...
            pom.withXml {
                asNode().apply {
                    ...
                    appendNode("description", "Adtalos adapter for AppLovin MAX mediation")
                    ...
                    // Add Adtalos to list of dependencies.
                    appendNode("dependencies").apply {
                        appendNode("dependency").apply {
                            appendNode("groupId", "com.xy.sdk")
                            appendNode("artifactId", "adtalos-sdk")
                            appendNode("version", libraryVersions["adtalos"])
